...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // ============================================================
    // КОНФИГУРАЦИЯ ВРЕМЕНИ (в секундах) - ПОЛНАЯ ПЛАВНОСТЬ
    // ============================================================
    // ИЗМЕНЕНО: Общая длина цикла увеличена до 35 секунд
    const ANIMATION_DURATION = 35;

    // ИЗМЕНЕНО:
    // 1. Точки одни всего 2 секунды
    const PHASE_QUIESCENCE_END = 2;

    // 2. Линии прорастают ПЛАВНО (с 2 по 6 секунду - 4 секунды на появление)
    const PHASE_CONNECTION_END = 6;

    // 3. Мозг формируется еще плавнее (до 10-й секунды)
    const PHASE_FORMATION_END = 10;

    // 4. ДОЛГОЕ УДЕРЖАНИЕ: (с 10 по 30 секунду = 20 секунд статики)
    const PHASE_HOLD_END = 30;

    // 5. Плавное растворение в конце (5 секунд)
    const PHASE_DISSOLUTION_END = 35;
    ...
    // Скорость (оставили медленной, как вы просили)
