...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // ============================================================
    const ANIMATION_DURATION = 25;     // Общая длительность цикла увеличена
    const PHASE_QUIESCENCE_END = 2;    // Ожидание всего 2 секунды
    const PHASE_CONNECTION_END = 3.5;  // Линии соединяются ОЧЕНЬ БЫСТРО (за 1.5 сек)
    const PHASE_FORMATION_END = 7;     // Мозг полностью сформирован на 7-й секунде
    const PHASE_HOLD_END = 18;         // ДОЛГОЕ УДЕРЖАНИЕ (до 18-й секунды мозг не распадается)
    const PHASE_DISSOLUTION_END = 25;  // Медленное растворение в конце
