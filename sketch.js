<!-- СТИЛИ ДЛЯ РАСТЯГИВАНИЯ НА ВЕСЬ ЭКРАН -->
<style>
    /* Убираем отступы и гарантируем, что canvas на заднем плане */
    #neural-canvas {
        ...
        width: 100%;
        height: 100%;
        z-index: 1; /* Уровень слоя (текст должен быть выше, например z-index: 10) */
        pointer-events: none; /* Чтобы сквозь анимацию можно было кликать по кнопкам */
        display: block;
    }
</style>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const PHASE_CONNECTION_END = 5;    
    const PHASE_FORMATION_END = 8;     
    const PHASE_HOLD_END = 18;         
